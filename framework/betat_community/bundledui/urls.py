...
urlpatterns = [
    ...
    path('admin', views.admin_dashboard_view, name='bundledui-admin'),
    path('admin/approve/<int:request_id>', views.approve_founding_request_view, name='bundledui-admin-approve'),
    ...
    path('timeline', views.timeline_view, name='bundledui-timeline'),
]
